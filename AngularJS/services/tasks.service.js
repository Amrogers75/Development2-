...
(function () {
    ...
    function todoService() {
        var self = this;
        //self.todoInput = '';
        self.todoList = [{todoText: 'Lawn', done: false}];

        self.todoAdd = function (todoInput) {
            self.todoList.push({todoText: todoInput, done: false});
            self.todoInput = "";
        };
...
(function () {
    ...
    angular.module('myApp')
        .service('characterService' name, $http characterService function);
