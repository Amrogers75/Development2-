...
var Miles = new Handler();
var Ava = new Handler();
var Tavas = new Handler();
var Taiden = new Handler();

export class Pokemon {
    static StartingHP = 100;
    name: string;
    trainerName: string;
    private hp: number;
    strength: number;
    ...
    constructor(name: string, trainerName: string, strength: number) {
        this.name = name;
